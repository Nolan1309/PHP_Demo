...
$total_records_query = "SELECT COUNT(DISTINCT p.idProduct) AS TotalProducts
FROM product p
JOIN SizeSanPham s ON p.idProduct = s.MaSP
WHERE s.GiaBan BETWEEN $from AND $to;";
$total_records_result = $conn->query($total_records_query);
$total_records_row = $total_records_result->fetch(PDO::FETCH_ASSOC);
$totalItems = $total_records_row['TotalProducts'];
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        <aside class="sidebar-wrapper">
                            ...
                            <h3 class="sidebar-title" style="margin-bottom:15px;"> Mức giá</h3>
                                ...
                                <div><a href="javascript:void(0);" onclick="ChangePrice(this, '2000000','2000000000')">Trên 2.000.000</a></div>
                    ...
                    <div class="col-lg-9 order-1 order-lg-2">
                        <div class="shop-product-wrapper">
                            ...
                            <div class="shop-product-wrap grid-view row mbn-40">
                                ...
                                <?php
                                $loadProductSP_ByPrice = $object->locgia($from, $to, $offset, $itemsPerPage);
                                foreach ($loadProductSP_ByPrice as $row) {
                            ...
                            <div class="paginatoin-area text-center">
                                <ul class="pagination-box">
                                    <!-- Nút previous -->
                                    <li><a class="previous" href="?View=shop-fill&page=<?php echo ($currentPage > 1) ? $currentPage - 1 : 1; ?>&from=<?php echo $from; ?>&to=<?php echo $to; ?>"><i class="lnr lnr-chevron-left"></i></a></li>

                                    <!-- Các nút trang -->
                                    <?php for ($i = 1; $i <= $totalPages; $i++) : ?>
                                        <li class="<?php echo ($i == $currentPage) ? 'active' : ''; ?>"><a href="?View=shop-fill&page=<?php echo $i; ?>&from=<?php echo $from; ?>&to=<?php echo $to; ?>"><?php echo $i; ?></a></li>
                                    <?php endfor; ?>

                                    <!-- Nút next -->
                                    <li><a class="next" href="?View=shop-fill&page=<?php echo ($currentPage < $totalPages) ? $currentPage + 1 : $totalPages; ?>&&from=<?php echo $from; ?>&to=<?php echo $to; ?>"><i class="lnr lnr-chevron-right"></i></a></li>
                                </ul>
                            </div>
                            <!-- end pagination area -->
                        </div>
